...
<div class="space-y-6">
    ...
    <div class="bg-[#FFFFFF] rounded-[2.5rem] border-4 border-slate-900 shadow-xl p-6 sm:p-8 space-y-6">
        <div>
            ...
            <p class="text-xs font-bold text-slate-400 uppercase tracking-wider mt-0.5 text-left">Click any row element below to view the client-facing approval view layout</p>
        </div>
        ...
        @if($estimates->count() > 0)
                ...
                <table class="w-full text-left border-collapse">
                    <thead>
                        <tr class="border-b border-slate-200 text-[10px] font-black text-slate-400 uppercase tracking-widest bg-slate-50">
                            ...
                            <th class="py-4 px-4 text-right">Quote Total</th>
                        </tr>
                    </thead>
                    <tbody class="text-sm font-bold divide-y divide-slate-100">
                        @foreach($estimates as $estimate)
                            <tr class="hover:bg-slate-50/80 transition cursor-pointer">
                                ...
                                <td class="py-4 px-4 text-right text-base font-black text-[#0F2D5A]">
            ...
            <div class="block md:hidden space-y-3">
                @foreach($estimates as $estimate)
                    <div class="bg-white border-2 border-slate-200/80 p-5 rounded-2xl text-left space-y-3 shadow-sm active:bg-slate-50 transition">
